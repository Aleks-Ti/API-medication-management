...
from tg_bot.drug_regimen.dependencies import manager_service, regimen_service
...
async def regimen_add_more(callback_query: types.CallbackQuery, state: FSMContext):
    try:
        ...
        logging.exception(f"Возможно плохой url был задан для regimen_add_more: {exc}")
        pass
