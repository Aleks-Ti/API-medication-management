...
from tg_bot.core.api_client import AbstractApiClient
from tg_bot.core.config import settings
from tg_bot.drug_regimen.requests import ManagerApiClient, RegimenApiClient
from tg_bot.drug_regimen.state_machine import ManagerState, RegimenState
from tg_bot.drug_regimen.utils import LOCAL_RU_MONTH, get_user_date
from tg_bot.drug_regimen_manager.service import DrManagerService
from tg_bot.user.service import UserService
from tg_bot.utils.buttons import InlineButtonsGenerator as ibg
from tg_bot.utils.validate_user_message import validate_input
